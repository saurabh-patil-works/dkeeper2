...
import { idlFactory } from './dkeeper2_backend.did.js';
export { idlFactory } from './dkeeper2_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DKEEPER2_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dkeeper2_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dkeeper2_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dkeeper2_backend.did.js")._SERVICE>}
 */
export const dkeeper2_backend = createActor(canisterId);
