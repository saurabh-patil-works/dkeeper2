...
import { idlFactory } from './dkeeper2_frontend.did.js';
export { idlFactory } from './dkeeper2_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DKEEPER2_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dkeeper2_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dkeeper2_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dkeeper2_frontend.did.js")._SERVICE>}
 */
export const dkeeper2_frontend = createActor(canisterId);
